...
package_name = 'automatix_my_slam'
...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'config'), glob('config/*.pgm')),#incluir
        (os.path.join('share', package_name, 'config'), glob('config/*.yaml')),#incluir
