...
class Predict:
    ...
    def predecir(args=None):
        ...
        image = '/home/tostyfis/turtlebot3_ws/src/AplicacionROS2/automatix/automatix_servicio_leer_qr/automatix_servicio_leer_qr/fotoDesdeRos.jpg' #path to input image
