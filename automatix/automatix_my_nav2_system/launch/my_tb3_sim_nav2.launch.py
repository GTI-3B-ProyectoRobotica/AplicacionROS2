...
def generate_launch_description():
    ...
    project_dir = get_package_share_directory('automatix_my_nav2_system')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(project_dir, 'config', 'my_nav2_params.yaml'),
    ...
    declare_world_cmd = DeclareLaunchArgument(
        'world',
        default_value= os.path.join(get_package_share_directory('automatix_my_world'),'world/burger.model'),
